...
└── api_facturas/
    ...
    ├── Dockerfile                    # sdk:10.0 + dotnet watch (puerto 8058)
    ├── Modelos/
...
funcionando. En v1 eso son **dos servicios**: `postgres` (15450 al host,
se siembra solo) y `api-facturas` (8058, código montado +
