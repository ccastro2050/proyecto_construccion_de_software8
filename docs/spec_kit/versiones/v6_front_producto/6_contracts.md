...
> HTML** y formularios que envían POST. Base: `http://localhost:8059`.
...
```
GET :8058/  → {"mensaje":"API Facturas funcionando","version":"v6","motor":"...","contratos":".../v6_front_producto/6_contracts.md"}
```
