...
Servicios: postgres · sqlserver (+init) · mariadb · api-facturas (:8058) ·
**front-flask (:8059)**.
...
# 3b. EN EL NAVEGADOR — http://localhost:8059
...
curl.exe http://localhost:8058/api/producto            # los mismos 8 de la tabla
```
