...
| **v6** | **El front NACE** (Flask + Jinja2 + Bootstrap, :8059): la marca del [MANUAL_DE_MARCA](../../MANUAL_DE_MARCA.md), login con sesión sobre verificar-contrasena, y el CRUD de producto desde el navegador | **Cerrada** — tag `v6` ([spec](v6_front_producto/2_spec.md)) |
