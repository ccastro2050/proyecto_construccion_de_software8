...
- [ ] `docker-compose.yml`: servicios `sqlserver` (2022, :11449,
...
docker compose exec sqlserver /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P "Construccion123!" -C -d bdfacturas_sqlserver_local -Q "SELECT COUNT(*) FROM producto"   # 8
```
