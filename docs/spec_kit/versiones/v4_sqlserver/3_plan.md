...
| `docker-compose.yml` | ★ servicios `sqlserver` (2022, :11449, healthcheck) + `sqlserver-init` + variables `Motor` y `ConnectionStrings__SqlServer` en la API |
...
- Puerto publicado **11449** (curso; la reconstrucción del estudiante
  usa 11549).
