...
Mapa de puertos: la familia de este curso termina en 42 (API 8058,
PostgreSQL 15450) — SQL Server toma **11449** (libre entre los 114xx ya
usados por otros cursos: 11463, 11563, 11432). La reconstrucción del
estudiante suma 100: **11549**.
