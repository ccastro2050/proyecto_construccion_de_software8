...
**Sus puertos:** API 8158 · PostgreSQL 15550 · **SQL Server 11549**
...
2. **La BD SQL Server y su inicializador** — cópielos tal cual del clon
   ...
   ```powershell
   Copy-Item ..\proyecto_construccion_de_software4\db\bdfacturas_sqlserver.sql db\
   Copy-Item ..\proyecto_construccion_de_software4\db\init_sqlserver.sh db\
   ```
...
- El ancla de stack queda igual; a los puertos +100 agregue:
  *"SQL Server publica en 11549 (no 11449)"*.
