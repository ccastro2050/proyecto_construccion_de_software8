...
> [README](../README.md)). PostgreSQL queda publicado en `localhost:15450`.
...
| Port | `15450` | El puerto del host del compose (`15450:1433`) |
...
> El puerto es la clave: **15450, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15450
...
>
> ```
> Error opening connection Failed to connect to localhost:15450
...
> (`http://localhost:8058/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15450) con test y guardarla |
