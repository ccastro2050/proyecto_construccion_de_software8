...
flowchart LR
    ...
    NAV -.->|"opcional (diagnóstico):<br/>localhost:15450"| POSTGRES
    NAV -.->|"opcional (diagnóstico):<br/>localhost:11449"| SQLSERVER
    NAV -.->|"opcional (diagnóstico):<br/>localhost:13349"| MARIADB
```
